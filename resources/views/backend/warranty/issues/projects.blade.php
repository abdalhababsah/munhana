    ...
    <div class="p-6">
        @if($projects->isEmpty())
            <div class="text-center py-10">
                <i class="uil uil-building text-5xl text-gray-300 mb-3"></i>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('backend.warranty-issues.index', $project) }}" class="btn btn-sm btn-primary">
                                    {{ __('messages.manage_warranty_issues') }}
                                </a>
                            </td>
                        </tr>
                        @endforeach
