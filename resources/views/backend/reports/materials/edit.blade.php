...
@section('content')
<div class="flex flex-col gap-6" x-data="{ selectedBoqItem: {{ $material->boqItem->toJson() }}, boqItems: {{ $boqItems->toJson() }} }">
    <!-- Back Button -->
                ...
                <div class="grid lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number"
                               ...
                               value="{{ old('quantity_delivered', $material->quantity_delivered) }}"
                               min="0"
                               step="0.01"
