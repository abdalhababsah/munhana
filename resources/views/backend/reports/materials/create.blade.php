...
@section('content')
    <div class="flex flex-col gap-6"
        x-data="{ selectedBoqItemId: '{{ old('boq_item_id', '') }}', boqItems: {{ $boqItems->toJson() }}, get selectedBoqItem() { return this.boqItems.find(item => item.id == this.selectedBoqItemId) } }">
        <!-- Back Button -->
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="quantity" name="quantity"
                                value="{{ old('quantity') }}" min="0" step="0.01"
                        ...
                        <div>
                            ...
                            <input type="text" id="received_by" name="received_by" value="{{ old('received_by') }}"
