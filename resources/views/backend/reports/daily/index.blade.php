...
@section('content')
    <div class="flex flex-col gap-6">
        ...
        <div class="card">
            <div class="p-6">
                <form method="GET" action="{{ route('backend.reports.daily.index', $project) }}"
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-1">
                                                    <div
                                                        class="text-sm font-semibold {{ $report->completion_percentage < 50 ? 'text-danger' : ($report->completion_percentage < 80 ? 'text-warning' : 'text-success') }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center gap-2">
                                                <a href="{{ route('backend.reports.daily.show', $report) }}"
                                                    class="text-info hover:text-info-dark" title="{{ __('messages.view') }}">
                                                ...
                                                <form method="POST" action="{{ route('backend.reports.daily.destroy', $report) }}"
