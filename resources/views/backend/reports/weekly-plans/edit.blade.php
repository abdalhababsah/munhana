...
@section('title', __('messages.edit') . ' ' . __('messages.weekly_plan') . ' - ' . (app()->getLocale() === 'ar' ? $project->name_ar : $project->name))
@section('page-title', __('messages.edit') . ' ' . __('messages.weekly_plan'))
...
<div class="flex flex-col gap-6">
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{ __('messages.edit') }} {{ __('messages.weekly_plan') }}</h4>
        </div>
        <div class="p-6">
            <form method="POST" action="{{ route('backend.weekly-plans.update', $weeklyPlan) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <textarea id="planned_activities"
                              ...
                              required>{{ old('planned_activities', $weeklyPlan->planned_activities) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="planned_activities_ar"
                              ...
                              placeholder="{{ __('messages.planned_activities_placeholder_ar') }}">{{ old('planned_activities_ar', $weeklyPlan->planned_activities_ar) }}</textarea>
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t">
                    ...
                    <button type="submit" class="btn btn-warning">
                        ...
                        {{ __('messages.update') }} {{ __('messages.weekly_plan') }}
                    </button>
                </div>
            </form>
        </div>
