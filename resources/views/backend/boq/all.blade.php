                            ...
                            @foreach($boqItems as $item)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($item->project)
                                            <a href="{{ route('backend.projects.show', $item->project) }}"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm font-semibold text-gray-900">{{ number_format($item->total_price, 2) }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-1">
                                                <div
                                                    class="text-sm font-semibold {{ $completion < 50 ? 'text-danger' : ($completion < 80 ? 'text-warning' : 'text-success') }}">
